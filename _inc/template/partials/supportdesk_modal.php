...
<div class="box-body">
	...
	<div class="row mb-20" style="margin-right:0;">
		<div class="col-sm-4">
			<a class="btn btn-info btn-block" href="mailto:yeshunator12@gmail.com">Email Us &rarr;</a>
		</div>
		<div class="col-sm-4">
			<a class="btn btn-warning btn-block" href="http://codecanyon.net/user/itsolution-24/follow" target="_blank">Follow Us &rarr;</a>
		</div>
		<div class="col-sm-4">
			<a class="btn btn-success btn-block" href="#" target="_blank">Contact Us &rarr;</a>
		</div>	
	</div>
	<br>
